...
data class PaymentModesStaticData(
    ...
    @SerializedName("text_promo_valid")                                 var text_promo_valid: String?,
    ...
    @SerializedName("text_offer_details")                               var text_offer_details: String?,
...
data class PaymentModesItemResponse(
    ...
    @SerializedName("offer_info")           var offerInfoList: ArrayList<OfferInfoArray>?,
...
data class OfferInfoArray(
    ...
    @SerializedName("notes")                var notesList: ArrayList<String>?,
