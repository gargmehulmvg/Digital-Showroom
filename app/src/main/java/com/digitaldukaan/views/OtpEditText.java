...
public class OtpEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private IOnOTPFilledListener mOtpFilledListener;

    public void setOtpFilledListener(IOnOTPFilledListener mOtpFilledListener) {
        this.mOtpFilledListener = mOtpFilledListener;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (textLength == 4 && mOtpFilledListener != null) {
            mOtpFilledListener.onOTPFilledListener(text.toString());
        }
    }
